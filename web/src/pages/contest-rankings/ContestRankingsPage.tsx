...
const METRIC_DEFINITIONS: Record<ContestRankingMetric, MetricDefinition> = {
  bronze: {
    ...
    description: '进入累计铜牌线所需的真实赛前阵容分；仅供同一竞赛年内比较。',
  },
  silver: {
    label: '银牌难度',
    shortLabel: '银牌',
    ...
    description: '进入累计银牌线所需的真实赛前阵容分；仅供同一竞赛年内比较。',
  },
  gold: {
    label: '金牌难度',
    shortLabel: '金牌',
    ...
    description: '进入金牌线所需的真实赛前阵容分；仅供同一竞赛年内比较。',
  },
  top3: {
    label: '前三难度',
    shortLabel: '前三',
    family: '前列门槛',
    eyebrow: 'Top three',
    description: '进入正式队伍前三所需的真实赛前阵容分；仅供同一竞赛年内比较。',
  },
  top10: {
    label: '前十难度',
    shortLabel: '前十',
    family: '前列门槛',
    eyebrow: 'Top ten',
    description: '进入正式队伍前十所需的真实赛前阵容分；仅供同一竞赛年内比较。',
  },
  overall: {
    label: '整体难度',
    shortLabel: '整体',
    ...
    description: '所有正式参赛队伍赛前阵容分的等权均值；仅供同一竞赛年内比较。',
  },
  weirdness: {
    label: '怪异分',
    shortLabel: '怪异',
