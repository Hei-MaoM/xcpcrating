...
function DetailTags({ tags }: { tags: readonly string[] }) {
  const shown = tags.slice(0, DETAIL_TAG_LIMIT)
  const rest = tags.slice(DETAIL_TAG_LIMIT)
  return (
